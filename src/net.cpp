...
void ThreadGetMyExternalIP(void* parg)
{
    ...
    RenameThread("DeltaCredits-ext-ip");
...
void ThreadMapPort(void* parg)
{
    ...
    RenameThread("DeltaCredits-UPnP");
...
void ThreadMapPort2(void* parg)
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "DeltaCredits " + FormatFullVersion();
#ifndef UPNPDISCOVER_SUCCESS
        /* miniupnpc 1.5 */
...
void ThreadDNSAddressSeed(void* parg)
{
    ...
    RenameThread("DeltaCredits-dnsseed");
...
void ThreadDumpAddress(void* parg)
{
    ...
    RenameThread("DeltaCredits-adrdump");
...
void ThreadOpenConnections(void* parg)
{
    ...
    RenameThread("DeltaCredits-opencon");
...
void ThreadMessageHandler(void* parg)
{
    ...
    RenameThread("DeltaCredits-msghand");
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. DeltaCredits is probably already running."), addrBind.ToString().c_str());
        else
...
void StartNode(void* parg)
{
    ...
    RenameThread("DeltaCredits-start");
